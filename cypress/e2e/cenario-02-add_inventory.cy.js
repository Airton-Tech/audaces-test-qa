describe(`Cenário 2: Funcionalidade de Adicionar ao Carrinho - ${Cypress.browser.name} - ${Cypress.isBrowser('headed') ? 'headed' : 'headless'}`, () => {
  ...
  it('CT-01: Adicionar o produto "Sauce Labs Bolt T-Shirt" ao carrinho pela página principal (/inventory)', () => {
  ...
  it('CT-02: Adicionar o produto "Sauce Labs Bolt T-Shirt" ao carrinho pela página do item (/inventory-item)', () => {
